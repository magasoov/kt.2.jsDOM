...
let contentDiv = document.getElementById('catContainer');
cats.forEach(function(person){
    
    let catCard = document.getElementById('catContainer')
    let catImage = document.createElement('img')
    catImage.src = person.img_link;
    catCard.appendChild(catImage)

    let personDiv = document.createElement('div');
    personDiv.innerHTML = '<strong>Имя:</strong>' + person.name + '<strong> Возвраст:</strong>'  + person.age  + '<strong> Описание:</strong>' + person.description;
    contentDiv.appendChild(personDiv)
});

let brTeg = createElement('br')
catCard.appendChild(brTeg);